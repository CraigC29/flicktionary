    ...
    $.ajax({
      ...
      success: function (result, status, xhr) {
        ...
        for (i = 0; i < result["results"].length; i++) {
          ...
          allResults.append("<div id=" + movieid + " class=\"result\" resourceId=\" titleText=\"" + result["results"][i]["title"] + "\">" + '<% if (loggedIn) { %> <img class="facouriteIcon" src="/public/images/favoutite.png" onClick="addFavourite()" /> <% } %> ' + "<img id=" + movieLocation + " class ='imageClick' src=\"" + image + "\"/>" + "</div>")
        }
