    ...
    $.ajax({
      ...
      success: function (result, status, xhr) {
        ...
        for (i = 0; i < result["results"].length; i++) {
          ...
          allResults.append("<div id=" + movieid + " class=\"result\" resourceId=\" titleText=\"" + result["results"][i]["title"] + "\">" +  '<img class="facouriteIcon" src="/public/images/favourite.png" onClick="addFavourite()" />'  + "<img id=" + movieLocation + " class ='imageClick' src=\"" + image + "\"/>" + "</div>")
        }
